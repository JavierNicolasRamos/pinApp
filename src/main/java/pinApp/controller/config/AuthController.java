package pinApp.controller.config;
...
import pinApp.config.JwtUtil;
import pinApp.dto.config.AuthDto;
import pinApp.enums.Role;
import pinApp.exception.UserNotFoundException;
import pinApp.response.AuthResponse;
import pinApp.service.UserService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@RequestBody @NotNull AuthDto authDto) throws Exception {
        ...
        AuthResponse response = new AuthResponse(jwt, role, email, name );
